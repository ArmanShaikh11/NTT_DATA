...
function App() {
  // Theme state controls whether the site is in light or dark mode.
  // We sync this with <html data-theme> and localStorage for persistence.
  const [theme, setTheme] = useState<"light" | "dark">(() => {
    const stored = localStorage.getItem("theme");
    if (stored === "light" || stored === "dark") return stored;
    // Fallback to system preference on first load if nothing stored
    const prefersDark =
      window.matchMedia &&
  ...
  useEffect(() => {
    // Apply to <html> as data attribute so CSS can react to it
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Optionally also send email via EmailJS after successful DB save
      try {
        ...
        console.warn("EmailJS failed, continuing:", emailErr);
      }
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex items-center gap-4">
            {/* Theme toggle switch - round with smooth sliding animation */}
            <button
              onClick={toggleTheme}
              aria-label="Toggle theme"
              className="relative w-14 h-8 rounded-full transition-transform duration-200 focus:outline-none"
              style={{
                // Track color responds to theme
  ...
  return (
    // Use CSS variables for base colors; section blocks can still use Tailwind classes
    <div
      className="font-sans"
        ...
        <div className="relative z-10 text-center px-4 sm:px-6 lg:px-8 max-w-5xl mx-auto">
          <div className="animate-fade-in-up">
            ...
            <p className="text-lg text-gray-400 mb-12 max-w-3xl mx-auto leading-relaxed">
              Join industry leaders and technology visionaries for an exclusive
              evening of networking, innovation, and strategic insights that
              will accelerate your digital transformation journey into the
              ...
              <div className="flex items-center justify-center text-white bg-black/40 backdrop-blur-sm px-6 py-4 rounded-lg border border-red-600/20">
                ...
                <div className="text-left">
                  ...
                  <div className="font-semibold">
                    Madras International Circuit, Mumbai, India
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-2xl mx-auto">
              Join the most influential CIOs and technology leaders for an
              evening that will shape the future of digital innovation.
            </p>
          </div>
              ...
              {!isSubmitted ? (
                ...
                <div className="text-center py-8">
                  ...
                  <p className="text-gray-300 mb-6">
                    ...
                    email shortly with event details and access information.
                  </p>
                  <button
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Where technology leadership meets innovation, and partnerships
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center mb-16">
            <div>
              ...
              <p className="text-lg text-gray-300 mb-6 leading-relaxed">
                CIO CONNECT is more than an event—it's a catalyst for
                transformation. We bring together the most influential
                technology leaders to share insights, forge partnerships, and
                accelerate the digital future of enterprise technology.
              </p>
              <p className="text-lg text-gray-300 mb-8 leading-relaxed">
                In an era where technology moves at the speed of light, staying
                ahead requires more than just keeping up—it demands
                collaboration, innovation, and strategic vision.
              </p>
            ...
            <div className="bg-black/40 backdrop-blur-lg rounded-2xl p-8 border border-blue-600/20">
              <blockquote className="text-xl text-gray-300 italic mb-6 leading-relaxed">
                "Join us for an evening of networking and shared vision, where
                technology leaders come together to shape the future of digital
                innovation and drive meaningful change across industries."
              </blockquote>
          ...
          <div className="grid md:grid-cols-4 gap-8 text-center">
            ...
            <div className="bg-black/40 backdrop-blur-lg rounded-xl p-6 border border-gray-700/50">
              ...
              <p className="text-gray-400">
                Pioneering solutions that transform industries
              </p>
            </div>
            ...
            <div className="bg-black/40 backdrop-blur-lg rounded-xl p-6 border border-gray-700/50">
              ...
              <p className="text-gray-400">
                Leveraging cutting-edge solutions for business growth
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
              ...
              <div className="space-y-3">
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-gray-300">
                    cioconnect@theaddressevents.com
                  </span>
                </div>
                <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <div className="flex space-x-4 mb-6">
                ...
                <a
                  href="#"
                  className="w-10 h-10 bg-gray-800 hover:bg-blue-800 rounded-lg flex items-center justify-center transition-colors"
                >
          ...
          <div className="border-t border-gray-800 pt-8 mt-8 text-center">
            <p className="text-gray-400">
              ...
              <span className="text-red-400 ml-1">
                CIO CONNECT - Racing to the Future
              </span>
            </p>
          </div>
        </div>
